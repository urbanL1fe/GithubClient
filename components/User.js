...
const User = props => (
  ...
  <Popup 
         ...
         contentStyle={{display:'flex', justifyContent:'center', borderRadius:'10px',backgroundColor:'#d3cce3', overflowY:'scroll',height:'90vh',width:'80vw'}}
         trigger={<li className="userListItem">
  <img src={props.url} />
...
</li>} modal closeOnDocumentClick lockScroll >
