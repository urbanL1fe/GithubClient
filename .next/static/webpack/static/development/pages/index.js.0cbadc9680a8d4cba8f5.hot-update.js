...
var UserList = function UserList(props) {
  ...
  function handleScroll() {
    ...
    if (document.getElementsByTagName('body').scrollTop >= document.getElementsByTagName('body').scrollHeight - document.getElementsByTagName('body').offsetHeight) {
      console.log("bot");
      setPage(page + 1);
...
//# sourceMappingURL=index.js.0cbadc9680a8d4cba8f5.hot-update.js.map