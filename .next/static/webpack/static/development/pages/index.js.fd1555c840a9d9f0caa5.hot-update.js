...
var UserList = function UserList(props) {
  ...
  function handleScroll() {
    ...
    if (document.getElementsById('main').scrollTop >= document.getElementsById('main').scrollHeight - document.getElementsById('main').offsetHeight) {
      console.log("bot");
      setPage(page + 1);
...
//# sourceMappingURL=index.js.fd1555c840a9d9f0caa5.hot-update.js.map