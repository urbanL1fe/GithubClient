...
var UserList = function UserList(props) {
  ...
  function handleScroll() {
    ...
    if (document.getElementById('main').offsetHeight >= document.getElementById('main').scrollTop - document.getElementById('main').offsetHeight) {
      console.log("bot");
      setPage(page + 1);
...
//# sourceMappingURL=index.js.71dc9810b2ae9b274481.hot-update.js.map