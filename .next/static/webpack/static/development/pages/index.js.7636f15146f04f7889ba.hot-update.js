...
var UserList = function UserList(props) {
  ...
  function handleScroll() {
    ...
    if (window.offsetHeight >= document.getElementById('main').scrollTop - document.getElementById('main').scrollHeight) {
      console.log("bot");
      setPage(page + 1);
...
//# sourceMappingURL=index.js.7636f15146f04f7889ba.hot-update.js.map