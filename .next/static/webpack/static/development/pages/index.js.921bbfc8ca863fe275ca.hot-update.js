...
var UserList = function UserList(props) {
  ...
  function handleScroll() {
    ...
    if (document.getElementById('main').offsetHeight >= document.getElementById('main').scrollHeight - document.getElementById('main').offsetHeight) {
      console.log("bot");
      setPage(page + 1);
...
//# sourceMappingURL=index.js.921bbfc8ca863fe275ca.hot-update.js.map