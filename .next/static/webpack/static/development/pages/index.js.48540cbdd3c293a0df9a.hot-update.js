...
var UserList = function UserList(props) {
  ...
  function handleScroll() {
    ...
    if (document.getElementById('main').offsetHeight >= document.getElementById('main').scrollTop - document.getElementById('main').scrollHeight) {
      console.log("bot");
      setPage(page + 1);
...
//# sourceMappingURL=index.js.48540cbdd3c293a0df9a.hot-update.js.map