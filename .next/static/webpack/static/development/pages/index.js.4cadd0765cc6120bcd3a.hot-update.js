...
var UserList = function UserList(props) {
  ...
  function handleScroll() {
    ...
    if (document.getElementsById('main').scrollTop >= document.getElementsById('main').scrollHeight - document.getElementById('main').offsetHeight) {
      console.log("bot");
      setPage(page + 1);
...
//# sourceMappingURL=index.js.4cadd0765cc6120bcd3a.hot-update.js.map