...
var UserList = function UserList(props) {
  ...
  function handleScroll() {
    ...
    if (document.getElementById('main').scrollTop <= document.getElementById('main').scrollHeight - document.getElementById('main').offsetHeight) {
      console.log("bot");
      setPage(page + 1);
...
//# sourceMappingURL=index.js.238f8720c599509c7f24.hot-update.js.map