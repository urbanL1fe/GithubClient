...
var UserList = function UserList(props) {
  ...
  function handleScroll() {
    ...
    if (document.getElementsById('main').scrollTop >= document.getElementById('main').scrollHeight - document.getElementById('main').offsetHeight) {
      console.log("bot");
      setPage(page + 1);
...
//# sourceMappingURL=index.js.1adc6565b8d5d930bfa1.hot-update.js.map